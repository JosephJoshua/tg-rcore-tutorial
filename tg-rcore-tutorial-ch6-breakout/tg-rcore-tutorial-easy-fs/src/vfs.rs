...
impl Inode {
    ...
    /// Get the inode_id for this inode
    ...
    /// Count hard links to the given inode_id in this directory
    ...
    /// Create a hard link: new directory entry pointing to same inode as old_name
    ...
    /// Unlink: remove directory entry. If nlink reaches 0, deallocate inode+data.
    pub fn unlink(&self, name: &str) -> isize {
        ...
        // Remove directory entry by swapping with last and shrinking
        self.modify_disk_inode(|root_inode| {
            let file_count = (root_inode.size as usize) / DIRENT_SZ;
