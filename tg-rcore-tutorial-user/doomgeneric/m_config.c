...
void M_LoadDefaults (void)
{
    ...
    {
        extra_defaults.filename = "doom.cfg";
    }
...
char *M_GetSaveGameDir(char *iwadname)
{
    ...
    else
    {
        ...
        topdir = M_StringJoin2(configdir, "savegame");
        M_MakeDirectory(topdir);

        // eg. ~/.chocolate-doom/savegames/doom2.wad/

        savegamedir = M_StringJoin4(topdir, DIR_SEPARATOR_S, iwadname,
                                   DIR_SEPARATOR_S);
        ...
        free(topdir);
#else
        savegamedir = M_StringJoin3(configdir, DIR_SEPARATOR_S, ".savegame/");
