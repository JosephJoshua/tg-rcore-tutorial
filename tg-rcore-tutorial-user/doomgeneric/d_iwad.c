...
static void CheckCollectorsEdition(void)
{
    ...
    {
        subpath = M_StringJoin3(install_path, DIR_SEPARATOR_S,
                               collectors_edition_subdirs[i]);
...
static char *CheckDirectoryHasIWAD(char *dir, char *iwadname)
{
    ...
    {
        filename = M_StringJoin3(dir, DIR_SEPARATOR_S, iwadname);
    }
...
char *D_FindWADByName(char *name)
{
    ...
    for (i=0; i<num_iwad_dirs; ++i)
    {
        ...
        path = M_StringJoin3(iwad_dirs[i], DIR_SEPARATOR_S, name);
