...
// 70 MiB — heap ends ~0x84800000, below DMA pool at 0x8500_0000.
...
/// User data pointer must be translated through the process's page table.
#[cfg(target_arch = "riscv64")]
fn handle_fb_write(caller_entity: usize, x: usize, y: usize, w: usize, h: usize, data_ptr: usize) -> usize {
    ...
    // Translate user virtual address to kernel-accessible pointer, row by row
